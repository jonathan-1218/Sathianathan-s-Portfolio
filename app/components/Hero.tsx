...
export default function Hero() {
  ...
  return (
    <section
      ...
      style={{ position: 'relative', minHeight: '100vh', background: '#faf9f7',
    ...
    >
      ...
      <div className="hero-inner" style={{ position: 'relative', zIndex: 5, width: '100%', maxWidth: 1280, margin: '0 auto', padding: '80px 56px 100px' }}>

        {/* Name */}
        <h1 style={{ fontFamily: 'var(--font-cormorant-var, serif)',
          fontSize: 'clamp(48px,8.5vw,130px)', fontWeight: 300,
        ...
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, marginBottom: 20,
          ...
          <span style={{ fontSize: 12, fontWeight: 300, color: '#9ca3af' }}>Founder & CEO —</span>
          <a href="https://amazepixels.com" target="_blank" rel="noopener noreferrer"
            style={{ fontSize: 12, fontWeight: 500, color: 'oklch(38% 0.16 12)', textDecoration: 'none', letterSpacing: '0.02em' }}>
            Amazepixels Technologies ↗
          </a>
        </div>
        ...
        {/* Tagline */}
        <p style={{ fontSize: 'clamp(17px,1.7vw,22px)', fontWeight: 300, color: '#374151',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16, flexWrap: 'wrap',
          ...
          <a href="/work" className="cta-primary" style={{ display: 'inline-flex', alignItems: 'center', gap: 10,
            padding: '16px 36px', background: 'oklch(38% 0.16 12)', color: '#fff',
            borderRadius: 100, textDecoration: 'none', fontSize: 15, fontWeight: 500, letterSpacing: '0.02em' }}>
            View My Work
          ...
          <a href="/#contact" className="cta-ghost" style={{ display: 'inline-flex', alignItems: 'center',
            padding: '15px 36px', border: '1.5px solid #e5e7eb', color: '#374151',
            borderRadius: 100, textDecoration: 'none', fontSize: 15, fontWeight: 400, letterSpacing: '0.02em' }}>
            Get In Touch
          </a>
        </div>

        {/* Stats strip */}
        <div className="hero-stats" style={{ display: 'flex', gap: 0, marginTop: 80,
          ...
          <div style={{ padding: '24px 40px', borderRight: '1px solid #e5e7eb' }}>
            <div style={{ fontFamily: 'var(--font-cormorant-var, serif)', fontSize: 44, fontWeight: 300, color: '#111827', lineHeight: 1 }}>
              200<span style={{ fontSize: 22, fontWeight: 400, color: 'oklch(38% 0.16 12)' }}>+</span>
            </div>
      ...
      <div style={{ position: 'absolute', right: -20, top: 68,
        ...
        pointerEvents: 'none', userSelect: 'none', letterSpacing: '-0.06em' }}>S</div>
    </section>
  )
}
